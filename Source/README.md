...
Eine nähere Erläuterung dazu kann in der BAchelorarbeit gefunden werden. Hier wird kurz die Bnezung der Projekte beschrieben.

Systemvorraussetzungen:
Es gelten einige Systemvorrausetzungen, um den Quellcode des Plugins bearebiten zu können.
