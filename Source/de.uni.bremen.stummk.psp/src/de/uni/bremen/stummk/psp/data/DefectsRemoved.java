...
/**
 * Represents a row in the defects removed table in the {@link ProjectPlanSummary}
 * 
 * @author Konstantin
 *
 */
@Entity
@Table(name = "defects_removed")
public class DefectsRemoved implements PersistenceItem, SummaryItem {
   ...
   */
  public DefectsRemoved(String title) {
    this.title = title;
    this.plan = 0;
    this.actual = 0;
    this.toDate = 0;
   ...
   * 
   */
  public DefectsRemoved(long ID, String title, double plan, double actual, double toDate, double toDatePercentage,
      double defPerHour) {
    this.ID = ID;
    this.title = title;
    this.plan = plan;
