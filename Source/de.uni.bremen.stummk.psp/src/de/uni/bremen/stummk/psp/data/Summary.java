...
/**
 * Represents a row in the summary table in the {@link ProjectPlanSummary}
 * 
 * @author Konstantin
 *
 */
@Entity
@Table(name = "summary")
public class Summary implements SummaryItem {
   ...
   * 
   */
  public Summary(long ID, String title, double plan, double actual, double toDate) {
    this.ID = ID;
    this.title = title;
    this.plan = plan;
    this.actual = actual;
